...
import common
from morehttp.message_parsing import parse_request_line, parse_headers, StatusLine, convert_first_line_to_bytes, \
...
async def handle_pay(reader, writer):
    ...
    print("POST request to /pay came with headers:\n")
